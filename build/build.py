...
javac = ""
javac = "javac --module-path lib\\javafx-sdk-11.0.2\\lib --add-modules javafx.base,javafx.media,javafx.graphics,javafx.swing,javafx.controls,javafx.fxml,javafx.web -cp lib\\fontawesomefx-8.2.jar;..\\src ..\\src\\secur3dit\\"
end_at = " -d ..\\" + "src"
